...
// \date 2019
//
// This is the fifth vector FE example program.  It mimics the first example
// but instead solves the uncoupled Poisson problem using a discontinuous basis (vector
// monomial basis). Additionally it demonstrates use of a non-linear solver
